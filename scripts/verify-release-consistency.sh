...
PLUGIN_FILE="$REPO_ROOT/wp-plugin/axtolab-ai-connector/axtolab-ai-connector.php"
...
MCPB_FILE="$REPO_ROOT/wp-plugin/axtolab-ai-connector/assets/axtolab-ai-connector.mcpb"
