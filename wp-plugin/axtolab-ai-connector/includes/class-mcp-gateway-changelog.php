...
class Axtolab_AI_Connector_Changelog {
	...
	/**
	 * Source of the change. `axtolab_ai_connector` is the default for any
	 * tool dispatched through the MCP transport / REST namespace.
	 */
	const SOURCE_MCP        = 'axtolab_ai_connector';
	...
	public static function create_table() {
		...
		$sql = "CREATE TABLE $table (
			...
			source VARCHAR(32) NOT NULL DEFAULT 'axtolab_ai_connector',
