...
* **WordPress 6.8 QA verified.** Tested on a real WordPress 6.8 testbed, including the Abilities API bridge, admin UI, media/upload flows, auth methods, and deactivate/reactivate behaviour.
