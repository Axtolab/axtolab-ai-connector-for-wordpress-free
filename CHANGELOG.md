...
- **Three authentication methods:** WordPress Application Passwords (HTTP Basic), OAuth 2.1 with PKCE S256 + Dynamic Client Registration (RFC 7591), and Bearer Token for MCP-over-HTTP transport.
